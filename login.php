...
if (Auth::check()) {
    $role = Auth::role();
    if ($role === 'super_admin') {
        header('Location: ' . (function_exists('gaia_url') ? gaia_url('admin/index.php') : 'admin/index.php'));
        exit;
    }
    if ($role === 'hotel_manager') {
        header('Location: ' . (function_exists('gaia_url') ? gaia_url('hotel/index.php') : 'hotel/index.php'));
        exit;
    }
    if ($redirect !== '') {
